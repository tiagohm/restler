          ...
          TabBar(
            ...
            tabs: [
              ...
              BlocBuilder<RequestBloc, RequestState>(
                cubit: widget.bloc,
                buildWhen: (a, b) {
                  return a.request.header.enabled != b.request.header.enabled ||
              ...
              child: TabBarView(
                children: [
                    ...
                    builder: (context, state) {
                      ...
                      // Text.
                        ...
                        return BlocBuilder<RequestBloc, RequestState>(
                          cubit: widget.bloc,
                          buildWhen: (a, b) {
                            return a.request.body.text != b.request.body.text ||
                  ...
                  BlocBuilder<RequestBloc, RequestState>(
                    cubit: widget.bloc,
                    buildWhen: (a, b) {
                      return a.request.query.queries != b.request.query.queries;
                    },
                    builder: (context, state) {
