...
class Mdi {
  ...
  static const broom = _MdiIconData(59905);
  static const certificate = _MdiIconData(59906);
  static const circle = _MdiIconData(59907);
  static const cookie = _MdiIconData(59908);
  static const disconnected = _MdiIconData(59909);
  static const donate = _MdiIconData(59910);
  static const duplicate = _MdiIconData(59911);
  static const environment = _MdiIconData(59912);
  static const export = _MdiIconData(59913);
...
class _MdiIconData extends IconData {
  const _MdiIconData(int codePoint) : super(codePoint, fontFamily: 'Mdi');
}
